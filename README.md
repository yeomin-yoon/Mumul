...
AI 에이전트를 연동한 실시간 상호작용 멀티플레이 메타버스입니다.

- 개발 인원: 5인 팀 프로젝트 (UE 2인 · AI 3인)
- 개발 기간: 2025.11 - 2026.01
- 개발 환경: Unreal Engine 5.4 · C++

[시연 영상](https://youtu.be/2TKjmAMTk1I) · [Notion](https://app.notion.com/p/349e6578029f8082a892e9375fa81651)

> 팀 프로젝트 포크입니다. 원본 저장소 — [khc534854/Mumul](https://github.com/khc534854/Mumul)
> 아래 ‘담당 구현’은 윤여민의 작업 범위입니다. 이후 ‘원본 프로젝트 문서’는 원본 저장소의 설명을 보존한 것으로, 윤여민 개인의 담당 범위를 뜻하지 않습니다.
...
> 출처: [khc534854/Mumul README](https://github.com/khc534854/Mumul/blob/main/README.md). 아래 역할·구현·회고는 원본 문서에 기재된 내용입니다. 윤여민의 담당 범위는 위 ‘담당 구현’ 항목을 참고해 주세요.
